...
let message = "sorry guys, because of table reservasion issue I coud only invite 2 of you.";
console.log(message);
//poping guests with an appologizing msg
while (friends.length > 2) {
    let removefriends = friends.pop();
    console.log(`\nSorry ${removefriends} I can't invite you to dinner, we will meet soon`);
}
let finalized = friends;
console.log(`\nhey ${finalized} You are still invited to Dinner`);
